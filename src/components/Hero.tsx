...
const Hero: React.FC = () => {
  ...
  const slideData: SlideData[] = [
    { id: 0, image: '/assets/Hero1.jpg', title: 'Trending Item', mainTittle: "WOMEN'S LATEST FASHION SALE", price: "$20" },
    { id: 1, image: '/assets/Hero3.jpg', title: 'Trending Accessories', mainTittle: "MODERN SUNGLASSES", price: "$15" },
    { id: 2, image: '/assets/Hero2.jpg', title: 'Sale Offer', mainTittle: "NEW FASHION SUMMER SALE", price: "$30" }
  ];
