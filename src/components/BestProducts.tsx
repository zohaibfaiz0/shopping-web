...
const BestProducts: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProducts = async (): Promise<void> => {
      try {
        const response = await fetch('https://677e96ff94bde1c1252ca084.mockapi.io/API/v1/products');
    ...
    <div>
      <div className='container pt-16'>
        <h2 className='pb-4 text-2xl text-center font-medium'>
          <span className='text-red-600'>━━</span> Best Selling Products <span className='text-red-600'>━━</span>
        </h2>
